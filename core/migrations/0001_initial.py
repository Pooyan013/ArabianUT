    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='car_pictures/')),
                ...
                ('owner', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='cars', to='core.owner')),
            ],
        ),
        migrations.CreateModel(
            name='RepairJob',
            fields=[
                ...
                ('timer_paused_at', models.DateTimeField(blank=True, null=True, verbose_name='Timer Paused At')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=10.0, max_digits=10, verbose_name='Part Price')),
